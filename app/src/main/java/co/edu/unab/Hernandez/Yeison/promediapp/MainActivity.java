...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(validacion()){
                    double resultados = primerCorte() * 0.5;
                    resultados += segundoCorte() * 0.5;

                    Intent intent= new Intent(MainActivity.this,ResultadoActivity.class);
                    intent.putExtra(EXTRAMESSAGE,resultados);
    ...
    public double segundoCorte(){
        double resultado=Double.valueOf(asistenciaCorteDos.getText().toString())*0.1 +Double.valueOf(trabajoClaseCorteDos.getText().toString())*0.3;
        double sesentaPorCientoCorteDos=Double.valueOf(primerentregable.getText().toString())*0.15 +Double.valueOf(segundoEntregable.getText().toString())*0.15+Double.valueOf(sustentacion.getText().toString())*0.15 +Double.valueOf(aplicacion.getText().toString())*0.15;;

        return resultado+sesentaPorCientoCorteDos;
    }
